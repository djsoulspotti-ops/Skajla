...
smart_calendar_bp = Blueprint('smart_calendar', __name__)
logger = get_logger(__name__)

@smart_calendar_bp.route('/calendar/smart')
@require_auth
@handle_errors(api=False)
def smart_calendar_page():
    """Pagina principale calendario"""
    user = session.get('user')
    return render_template('calendar.html', user=user)

@smart_calendar_bp.route('/api/calendar/events', methods=['GET'])
@require_auth
@handle_errors(api=True)
def smart_get_events():
...
@smart_calendar_bp.route('/api/calendar/events', methods=['POST'])
@require_auth
@handle_errors(api=True)
...
@smart_calendar_bp.route('/api/calendar/class/<int:class_id>', methods=['GET'])
@require_auth
@handle_errors(api=True)
...
@smart_calendar_bp.route('/api/calendar/school-event', methods=['POST'])
@require_role('dirigente')
@handle_errors(api=True)
def smart_create_school_event():
...
@smart_calendar_bp.route('/api/calendar/user/<int:user_id>', methods=['GET'])
@require_role('dirigente')
@handle_errors(api=True)
...
@smart_calendar_bp.route('/api/calendar/chatbot/update', methods=['POST'])
@require_auth
@handle_errors(api=True)
